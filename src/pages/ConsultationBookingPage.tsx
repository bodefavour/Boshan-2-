...
const ConsultationLandingPage = () => {
  return (
    <div className="bg-[#FFF8F5] text-black">
      {/* Hero Section */}
      <section className="relative w-full h-[80vh] md:h-screen flex items-center justify-center px-6">
        ...
        <div className="relative z-10 max-w-3xl text-center text-white p-8 md:p-14 bg-black/40 backdrop-blur-xl rounded-3xl space-y-4">
          <motion.h1
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-8">
            {[
              ...
              <div
                key={i}
                className="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition space-y-2"
              >
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            "My acne cleared in 4 weeks.",
            "Best skin advice I’ve ever gotten.",
            "The follow-up system is a game-changer.",
          ].map((quote, idx) => (
            <blockquote
              key={idx}
              className="bg-white p-6 rounded-lg shadow hover:shadow-md transition text-sm italic text-gray-700"
            >
              “{quote}”
            </blockquote>
          ))}
      ...
      <section className="bg-[#fde8dd] py-16 px-6 text-center">
        <h2 className="text-2xl md:text-3xl font-semibold text-gray-800">
          Your skin deserves more than guesses.
        </h2>
        <p className="text-sm md:text-base text-gray-700 mt-2">
          Let’s make skincare make sense — for you.
        </p>
        <Link to="/consultation/booking">
